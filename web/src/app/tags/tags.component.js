...
var TagsComponent = (function () {
    function TagsComponent(ActivatedRoute, tagApi) {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        _a = this;
                        return [4 /*yield*/, this.tagApi.findById(this.tagId, { include: { relation: "photos", scope: { include: ['tags', 'album', 'owner'], order: "createdAt DESC" } } }).toPromise()];
                    case 1:
                        _a.tag = _b.sent();
                        return [2 /*return*/];
                }
