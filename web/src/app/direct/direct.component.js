...
var DirectComponent = (function () {
    function DirectComponent(dialogRef, data, userApi, auth, formBuilder, messageApi) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _a = this;
                        return [4 /*yield*/, this.userApi.getFriends(this.auth.getCurrentUserId()).toPromise()];
                    case 1:
                        _a.friends = _b.sent();
                        return [2 /*return*/];
                }
    ...
    DirectComponent.prototype.onNoClick = function () {
        this.dialogRef.close();
    };
    DirectComponent.prototype.direct = function (friend) {
        var _this = this;
...
DirectComponent = __decorate([
    ...
    __metadata("design:paramtypes", [MatDialogRef, Object, SocialNetUserApi,
        LoopBackAuth,
        FormBuilder,
        MessageApi])
], DirectComponent);
