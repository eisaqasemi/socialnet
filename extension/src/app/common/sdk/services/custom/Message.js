...
var MessageApi = (function (_super) {
     ...
     * </em>
     */
    MessageApi.prototype.getSender = function (id, refresh, customHeaders) {
     ...
     * </em>
     */
    MessageApi.prototype.getSocialNetUser = function (id, refresh, customHeaders) {
        if (refresh === void 0) { refresh = {}; }
        var _method = "GET";
        var _url = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
            "/messages/:id/socialNetUser";
        var _routeParams = {
            id: id
        };
        var _postBody = {};
     ...
     * </em>
     */
    MessageApi.prototype.getPhoto = function (id, refresh, customHeaders) {
        if (refresh === void 0) { refresh = {}; }
        var _method = "GET";
        var _url = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
            "/messages/:id/photo";
