...
var FriendsComponent = (function () {
    function FriendsComponent(userApi, auth, friendship) {
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        _a = this;
                        _b = parseInt;
                        return [4 /*yield*/, this.auth.getCurrentUserId()];
                    case 1:
                        _a.userId = _b.apply(void 0, [_c.sent()]);
                        this.getFriends();
                        return [2 /*return*/];
                }
            });
    ...
    FriendsComponent.prototype.search = function () {
        var _this = this;
        this.userApi.search(this.query).subscribe(function (val) {
            _this.users = val;
        });
    };
    FriendsComponent.prototype.unfriend = function (user) {
        var _this = this;
    ...
    FriendsComponent.prototype.getFriends = function () {
        var _this = this;
        this.userApi.getFriends(this.userId).subscribe(function (friends) {
            _this.friends = friends;
        });
    };
    FriendsComponent.prototype.friend = function (user) {
        return __awaiter(this, void 0, void 0, function () {
            var _this = this;
...
FriendsComponent = __decorate([
    ...
    __metadata("design:paramtypes", [SocialNetUserApi,
        LoopBackAuth,
        FriendshipApi])
], FriendsComponent);
