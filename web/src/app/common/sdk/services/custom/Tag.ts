...
export class TagApi extends BaseLoopBackApi {
   ...
   * </em>
   */
  public linkPhotos(id: any, fk: any, data: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "PUT";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
   ...
   * This method returns no data.
   */
  public unlinkPhotos(id: any, fk: any, customHeaders?: Function): Observable<any> {
    let _method: string = "DELETE";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/tags/:id/photos/rel/:fk";
    let _routeParams: any = {
   ...
   * </em>
   */
  public existsPhotos(id: any, fk: any, customHeaders?: Function): Observable<any> {
