...
var MessagesComponent = (function () {
    function MessagesComponent(messageApi, auth) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_d) {
                switch (_d.label) {
                    ...
                    case 1:
                        _a.userId = _b.apply(void 0, [_d.sent()]);
                        _c = this;
                        return [4 /*yield*/, this.messageApi.find({ where: {
                                    or: [
...
MessagesComponent = __decorate([
    ...
    __metadata("design:paramtypes", [MessageApi,
        LoopBackAuth])
], MessagesComponent);
